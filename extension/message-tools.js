...
(function addMarkAllAsReadButton() {
  ...
  function insertButton() {
    ...
    if (!downloadButton) {
      console.log('[BetterE-class] Download button not found, retrying...');
      return;
    }

    // Check if button already exists
    if (document.getElementById('betterEclassMarkAllAsRead')) {
      console.log('[BetterE-class] Mark all as read button already exists');
      return;
    }
    ...
    console.log('[BetterE-class] Mark all as read button added successfully');
  }
