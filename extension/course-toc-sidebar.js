...
(function() {
  ...
  chrome.storage.sync.get({
    ...
    settings = items;
    console.log('[BetterE-class] TOC sidebar settings loaded:', settings);
    ...
    if (settings.enableTocSidebar) {
      ...
      console.log('[BetterE-class] TOC sidebar is disabled in settings');
    }
  });
  ...
  chrome.storage.onChanged.addListener((changes, namespace) => {
    if (namespace === 'sync' && changes.enableTocSidebar) {
      ...
      console.log('[BetterE-class] TOC sidebar setting changed:', settings.enableTocSidebar);
  ...
  function init() {
    ...
    if (tocItems.length === 0) {
      console.log('[BetterE-class] TOC list is empty, creating flat structure');
      createFlatSidebar();
      return;
    }
  ...
  function createFlatSidebar() {
    ...
    console.log(`[BetterE-class] Creating flat sidebar with ${allMaterials.length} materials`);
